...
export default App;
`,description:"<p>We preset a series of colorful Badge styles for use in different situations. You can also set it to a hex color string for custom color.</p>"}},{demo:{id:"components-badge-demo-ribbbon"},previewerProps:{title:"Ribbon",filename:"components/badge/demo/ribbbon.tsx",jsx:`import React from 'react';
...
export default App;
`,description:"<p>Use ribbon badge.</p>"}},{demo:{id:"components-badge-demo-ribbon-debug"},previewerProps:{debug:!0,title:"Ribbon Debug",filename:"components/badge/demo/ribbon-debug.tsx",jsx:`import React from 'react';
import { Badge, Card, Space } from 'antd';
const App = () => (
  <Space
    direction="vertical"
