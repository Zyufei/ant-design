    ...
    >
      <Form
        ...
        onValuesChange={(_, nextData) => {
          setData({
            ...nextData,
            colorPrimary: nextData.colorPrimary.hex,
          });
        }}
        name="theme"
